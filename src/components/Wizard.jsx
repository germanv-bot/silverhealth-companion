...
export default function HealthWizard({ onReset }) {
  ...
  const renderStep = () => {
    switch(step) {
      case 0:
        return (
          <div className="text-center animate-fade-in">
            ...
            <h3 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4">Paso 1: Tu Edad</h3>
            <label className="block text-xl text-gray-700 mb-6 font-medium">¿Cuántos años tienes?</label>
            <input
              type="number"
              name="age"
              value={formData.age}
              onChange={handleChange}
              className="w-48 text-5xl p-6 border-4 border-blue-300 rounded-2xl text-center focus:border-blue-600 focus:ring-4 focus:ring-blue-100 outline-none transition-all shadow-lg bg-gradient-to-br from-white to-blue-50"
              placeholder="65"
            />
          </div>
        );
      case 1:
        return (
          <div className="text-center animate-fade-in">
            ...
            <h3 className="text-3xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent mb-4">Paso 2: Peso</h3>
            <label className="block text-xl text-gray-700 mb-6 font-medium">Ingresa tu peso (kg)</label>
            <input
              type="number"
              name="weight"
              value={formData.weight}
              onChange={handleChange}
              className="w-48 text-5xl p-6 border-4 border-green-300 rounded-2xl text-center focus:border-green-600 focus:ring-4 focus:ring-green-100 outline-none transition-all shadow-lg bg-gradient-to-br from-white to-green-50"
              placeholder="70"
            />
          </div>
        );
      case 2:
        return (
          <div className="text-center animate-fade-in">
            ...
            <h3 className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-violet-600 bg-clip-text text-transparent mb-4">Paso 3: Altura</h3>
            <label className="block text-xl text-gray-700 mb-6 font-medium">Ingresa tu altura (cm)</label>
            <input
              type="number"
              name="height"
              value={formData.height}
              onChange={handleChange}
              className="w-48 text-5xl p-6 border-4 border-purple-300 rounded-2xl text-center focus:border-purple-600 focus:ring-4 focus:ring-purple-100 outline-none transition-all shadow-lg bg-gradient-to-br from-white to-purple-50"
              placeholder="170"
            />
          </div>
        );
      case 3:
        return (
          <div className="text-center animate-fade-in">
            ...
            <h3 className="text-3xl font-bold bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent mb-4">Paso 4: Cintura</h3>
            <label className="block text-xl text-gray-700 mb-2 font-medium">Circunferencia de la cintura (cm)</label>
            ...
            <input
              ...
              onChange={handleChange}
              className="w-48 text-5xl p-6 border-4 border-orange-300 rounded-2xl text-center focus:border-orange-600 focus:ring-4 focus:ring-orange-100 outline-none transition-all shadow-lg bg-gradient-to-br from-white to-orange-50"
              placeholder="95"
            />
          </div>
        );
      case 4:
        return (
          <div className="text-center w-full max-w-2xl animate-fade-in">
            ...
            <h3 className="text-3xl font-bold bg-gradient-to-r from-rose-600 to-pink-600 bg-clip-text text-transparent mb-4">Paso 5: Condiciones</h3>
            <p className="text-xl text-gray-700 mb-8 font-medium">Selecciona las que apliquen a ti:</p>
            <div className="space-y-4">
              {[
                ...
                <div
                  ...
                  className={`p-5 border-3 rounded-2xl cursor-pointer flex items-center transition-all duration-200 transform hover:scale-102 ${
                ...
                >
                  ...
                  <span className="text-2xl font-medium text-gray-800">{cond.label}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      case 5:
        ...
        return (
          <div className="text-left w-full max-w-4xl animate-fade-in pb-8">
            <div className="text-center mb-10">
              ...
              <h3 className="text-4xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent mb-3">Chequeo Completado</h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-3xl border-2 border-blue-200 mb-8 shadow-xl">
              ...
              <ul className="space-y-5">
                {report.map((item, idx) => (
                  <li key={idx} className="bg-white p-6 rounded-2xl shadow-md border-l-4 border-blue-500 hover:shadow-lg transition-shadow">
                    <strong className="block text-2xl text-gray-900 mb-3 font-bold">{item.title}</strong>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-3xl border-2 border-green-200 shadow-xl">
              ...
              <ul className="space-y-4">
                {dietTips.map((tip, idx) => (
                  <li key={idx} className="flex items-start gap-3 bg-white p-5 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                    <div className="flex-shrink-0 mt-1">
                      <svg className="w-6 h-6 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
                      </svg>
                    </div>
                    <span className="text-2xl text-green-900 font-medium leading-relaxed">{tip}</span>
                  </li>
                ))}
              </ul>
            </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-5xl mx-auto p-4">
      ...
      {/* Contenido del Paso */}
      <div className="bg-white p-10 rounded-3xl shadow-2xl w-full min-h-[450px] flex flex-col items-center justify-center border-2 border-gray-100">
        {renderStep()}
      </div>
      ...
      <div className="flex justify-between w-full mt-10 gap-4">
        ...
        {step < 5 && (
          <button
            onClick={nextStep}
            className="group text-3xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-14 py-5 font-bold rounded-xl shadow-2xl transform transition-all duration-200 hover:scale-105 hover:shadow-3xl"
          >
