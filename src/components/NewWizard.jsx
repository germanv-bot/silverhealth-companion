...
export default function NewWizard({ onReset }) {
  ...
  if (analysis) {
    return (
      <div className="w-full max-w-full sm:max-w-3xl md:max-w-4xl lg:max-w-5xl mx-auto p-3 sm:p-4 md:p-5 lg:p-6 animate-fade-in">
        <div className="text-center mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent mb-3">
            Análisis Completado
          </h2>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border-2 border-gray-200 mb-8">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 justify-center">
            ...
            <button
              onClick={handleCopy}
              className={`w-full sm:w-auto group flex items-center justify-center gap-3 font-bold px-6 sm:px-7 md:px-8 py-3 sm:py-3.5 md:py-4 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl transform hover:scale-105 text-base sm:text-lg ${
                copied
        ...
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-4 sm:p-6 md:p-8 rounded-3xl border-2 border-purple-200 shadow-xl mb-8">
          <div className="text-center">
            ...
            <button
              ...
              className="w-full sm:w-auto group inline-flex items-center justify-center gap-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white text-xl font-bold px-10 py-5 rounded-2xl shadow-2xl transition-all duration-300 hover:shadow-3xl transform hover:scale-105"
            >
  ...
  if (isAnalyzing) {
    return (
      <div className="w-full max-w-full sm:max-w-xl md:max-w-2xl lg:max-w-3xl mx-auto p-8 text-center">
        <div className="bg-white p-6 sm:p-8 md:p-10 lg:p-12 rounded-3xl shadow-2xl">
          <div className="animate-spin rounded-full h-16 w-16 sm:h-18 sm:w-18 md:h-20 md:w-20 border-b-4 border-blue-600 mx-auto mb-6"></div>
          <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Analizando sus respuestas...</h3>
  ...
  if (error) {
    return (
      <div className="w-full max-w-full sm:max-w-xl md:max-w-2xl lg:max-w-3xl mx-auto p-8">
        <div className="bg-red-50 border-2 border-red-300 p-4 sm:p-6 md:p-8 rounded-2xl">
          <div className="flex flex-col sm:flex-row items-start gap-4 mb-6">
            <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-red-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <button
            ...
            className="w-full sm:w-auto bg-red-600 hover:bg-red-700 text-white font-bold px-6 py-3 rounded-lg transition-all"
          >
            Reintentar
          </button>
        </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-full sm:max-w-2xl md:max-w-4xl lg:max-w-6xl mx-auto p-2 sm:p-3 md:p-4">
      {/* Barra de progreso */}
      <div className="w-full bg-gray-200 h-2 sm:h-2.5 md:h-3 rounded-full mb-4 sm:mb-5 md:mb-6 overflow-hidden shadow-inner">
        <div
      ...
      <div className="mb-6 text-center">
        <span className="bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 px-3 py-1.5 sm:px-4 sm:py-2 md:px-5 md:py-2 rounded-full text-base sm:text-lg font-bold shadow-sm">
      ...
      <div className="bg-white p-4 sm:p-6 md:p-8 lg:p-10 rounded-2xl sm:rounded-3xl shadow-2xl w-full border-2 border-gray-100">
        <div className="mb-8">
        ...
        <div className="max-h-[400px] sm:max-h-[450px] md:max-h-[500px] overflow-y-auto pr-2">
          <QuestionRenderer
      ...
      <div className="flex flex-col-reverse sm:flex-row justify-between w-full mt-6 sm:mt-8 md:mt-10 gap-3 sm:gap-4">
        ...
        <button
          ...
          className="w-full sm:w-auto group text-xl sm:text-2xl md:text-3xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-8 sm:px-10 md:px-12 lg:px-14 py-3 sm:py-4 md:py-5 font-bold rounded-xl shadow-2xl transform transition-all duration-200 hover:scale-105"
        >
